...
#include <LittleFS.h>
#include "games/Flappy Bird.hpp"
#include "games/Snake.hpp"
#include "games/Pong.hpp"
#include "games/Space Invaders.hpp"
...
void setup() {
  ...
  menu.AddItem(MenuItem("BlE", &menu_bluetooth));
  menu.AddItem(MenuItem("IR", &menu_infrared));
  menu.AddItem(MenuItem("RF", &menu_rf));
  menu.AddItem(MenuItem("Other", &menu_others));
  ...
  menu_universal_remote.AddItem(MenuItem("Whiteboards", [&]() { IR_UniversalRemote(REMOTE_TYPE_WHITEBOARDS); }));
  ...
  menu_others.AddItem(MenuItem("Sound", &menu_sound));
  menu_others.AddItem(MenuItem("Games", &menu_games));

  menu_games.AddItem(MenuItem("Flappy bird", FlappyBird));
  menu_games.AddItem(MenuItem("Snake", SnakeGame));
  menu_games.AddItem(MenuItem("Pong", PongGame));
  menu_games.AddItem(MenuItem("Space Invaders", SpaceInvaders));
